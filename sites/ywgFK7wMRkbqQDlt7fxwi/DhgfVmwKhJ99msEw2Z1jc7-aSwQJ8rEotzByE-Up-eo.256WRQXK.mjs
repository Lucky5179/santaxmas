import { a as Hr } from "./chunk-AMPAD3AD.mjs";
import {
  a as ut,
  b as wt,
  c as xt,
...
import { b as D } from "./chunk-Y5FTINFI.mjs";
function Me(r) {
  let {
      label: a,
      content: o,
    ...
    H = vr({ fontWeight: 500, ...n }),
    C = yr(r),
    k = br(r),
    w = Ze(() => {
      var _;
      (_ = D.clipboard) === null || _ === void 0 || _.writeText(o), d?.();
    }, [d, o]);
  return e(m.button, {
    style: {
      border: "none",
...
function kt(r) {
  ...
  r = r.replace(ca, "");
  var o = pa.test(r);
  return o || fa.test(r) ? da(r.slice(2), o ? 2 : 8) : ma.test(r) ? Ct : +r;
}
function ga(r, a, o) {
  var s,
    f,
    ...
    C = !1,
    k = !0;
  if (typeof r != "function") throw new TypeError(Ft);
  (a = kt(a) || 0),
    Cr(o) &&
      ((H = !!o.leading),
      (C = "maxWait" in o),
      (g = C ? sa(kt(o.maxWait) || 0, a) : g),
  ...
  function _(h) {
    return (n = h), (x = setTimeout(q, a)), H ? w(h) : d;
  }
  function P(h) {
    var t = h - u,
      y = h - n,
      he = a - t;
    return C ? la(he, g - y) : he;
  }
  function Z(h) {
    var t = h - u,
      y = h - n;
    return u === void 0 || t >= a || t < 0 || (C && y >= g);
  }
  function q() {
    var h = Wr();
    if (Z(h)) return p(h);
  ...
  function p(h) {
    return (x = void 0), k && s ? w(h) : ((s = f = void 0), d);
  }
  function z() {
    x !== void 0 && clearTimeout(x), (n = 0), (s = u = f = x = void 0);
  }
  function N() {
    return x === void 0 ? d : p(Wr());
  }
  function I() {
    var h = Wr(),
      t = Z(h);
    if (((s = arguments), (f = this), (u = h), t)) {
      ...
      if (C) return clearTimeout(x), (x = setTimeout(q, a)), w(u);
    }
    return x === void 0 && (x = setTimeout(q, a)), d;
  }
  return (I.cancel = z), (I.flush = N), I;
}
function St(r, a, o) {
  var s = !0,
    f = !0;
...
var We = B(
  function (a) {
    let {
      ...
      V = Ze(
        (L, ze) => {
          Ve(L),
            u && u(L),
            ge ? hr(ze, L, z) : requestAnimationFrame(() => ze.set(L));
        },
        [z, ge, u]
      ),
      U = xr(o, { onChange: V, transform: (L) => ct(L, [0, 100], [d, x]) }),
      be = Dr(U, [d, x], ["0%", "100%"]),
      fr = Dr(U, [d, x], [0, 1]),
      Ve = Ze(
        St((L) => {
          var ze;
          !((ze = S.current) === null || ze === void 0) &&
            ze.value &&
            (S.current.value = L);
        }, 100),
        [S]
    ...
    wr(U, (L) => {
      bt(o) && Ve(L), H && L >= x && H(), C && L <= d && C(), n && n(L);
    });
    let dr = (L) => {
        V(parseFloat(L.target.value), U);
      },
      Pe = (L) => {
        parseFloat(L.target.value) !== 0 && V(parseFloat(L.target.value), U);
      },
      Lr = () => {},
      Je = xe ? _ + i : i,
      Ee = Math.max(_ + i, s);
    return v("div", {
      ...
      style: {
        ...
        border: `0px solid ${g}`,
        "--framer-default-slider-height": Ee,
        "--framer-default-slider-width": Je,
      },
      children: [
        e("input", {
          ref: S,
          style: {
            ...
            ...h,
            WebkitTapHighlightColor: "rgba(0, 0, 0, 0)",
            ...(!ne && { width: `calc(100% + ${Je}px)`, marginLeft: -Je / 2 }),
          },
          onFocus: () => ue(!0),
          onBlur: () => ue(!1),
          type: "range",
        ...
        e(m.div, {
          ...
          children: e(m.div, {
            initial: !1,
            animate: { scale: (t && I === Re.Hover) || I === Re.Show ? 1 : 0 },
...
Q(We, {
  ...
  transition: { type: c.Transition, defaultValue: We.defaultProps.transition },
  knobSetting: {
    type: c.Enum,
  ...
  constrainKnob: {
    ...
    enabledTitle: "Yes",
    disabledTitle: "No",
    hidden: ({ knobSetting: r }) => r !== Re.Show,
  },
  knobSize: {
    type: c.Number,
    title: "Knob",
    min: 10,
    max: 100,
    hidden: ({ knobSetting: r }) => r === Re.Hide,
  },
  ...
  Qe = B(
    function (a) {
      ...
      let [ne, xe] = Se(!1),
          ...
          (X) => {
            ...
            if (
              (($e = U.current) === null ||
                ...
                ve === void 0 ||
                ve.stop(),
              Math.abs(Br - be.get()) > 0.5 && be.set(Br),
              !Pe)
            )
              return;
            let jr = ua(V);
        ...
        ta = () => {
          At(P) || (V.current.currentTime = P * 0.01 * V.current.duration);
        },
        aa = () => {
          U.current.ready || (Ee && gr(), (U.current.ready = !0), ta());
        },
        ia = (X) => {
          V.current.currentTime &&
            ((V.current.currentTime = X), L("handleSeek"));
        },
        oa = () => {
          he && he();
        },
      ...
      let ot = { marginRight: q || p ? x : 0, flexShrink: 0, cursor: ge };
      return v("div", {
        style: {
          ...wt,
          position: "relative",
        ...
        children: [
          e("audio", {
            ...
            onLoadedMetadata: ra,
            onCanPlayThrough: aa,
            onPlaying: () => L("playingEvent"),
            onPlay: () => L("playEvent"),
            onSeeked: () => L("seekEvent"),
            onPause: () => L("pauseEvent"),
            onEnded: () => oa(),
          }),
          N &&
            e(Ne, {
...
Q(Qe, {
  ...
  progressColor: {
    title: "Progress",
    type: c.Color,
    defaultValue: Qe.defaultProps.progressColor,
  },
  trackColor: {
    title: "Track",
    type: c.Color,
    defaultValue: Qe.defaultProps.trackColor,
  },
  background: {
    title: "Player",
    type: c.Color,
    defaultValue: Qe.defaultProps.background,
  },
...
var Xr = [
  ...
  qt = ["thin", "light", "regular", "bold", "fill", "duotone"],
  Ha = Xr.reduce((r, a) => ((r[a.toLowerCase()] = a), r), {});
function Ae(r) {
  let {
      color: a,
      selectByList: o,
    ...
    k = O(!1),
    w = Sr(Xr, o, s, f, Ha),
    [_, P] = Se(w === "Home" ? Vt(pe) : null);
  async function Z() {
    try {
      let I = await import(`${_a}${w}.js@0.0.53`);
      k.current && P(I.default(pe));
    } catch {
      k.current && P(null);
    }
  }
  ...
  let p = Ce.current() === Ce.canvas ? e(kr, {}) : null;
  return e(m.div, {
    ...
    children: _
      ? e("svg", {
          ...
          focusable: "false",
          color: a,
          children: e(_, { color: a, weight: H }),
        })
      : p,
  });
}
Ae.displayName = "Phosphor";
Ae.defaultProps = {
  width: 24,
  height: 24,
  iconSelection: "House",
...
Q(Ae, {
  selectByList: {
    ...
    defaultValue: Ae.defaultProps.selectByList,
  },
  iconSelection: {
    type: c.Enum,
    options: Xr,
    defaultValue: Ae.defaultProps.iconSelection,
    title: "Name",
  ...
  color: { type: c.Color, title: "Color", defaultValue: Ae.defaultProps.color },
  weight: {
    type: c.Enum,
    title: "Weight",
    optionTitles: qt.map((r) => r.charAt(0).toUpperCase() + r.slice(1)),
    options: qt,
    defaultValue: Ae.defaultProps.weight,
  },
  mirrored: {
    type: c.Boolean,
    enabledTitle: "Yes",
    disabledTitle: "No",
    defaultValue: Ae.defaultProps.mirrored,
  },
  ...Fr,
});
var Ca = W(Ae),
...
var Ia = { delay: 0, duration: 0.2, ease: [0.44, 0, 0.56, 1], type: "tween" },
  ...
  Oa = { delay: 0, duration: 0.1, ease: [0.44, 0, 0.56, 1], type: "tween" },
  Ra = {
    opacity: 1,
    rotate: 0,
    rotateX: 0,
  ...
  Pa = ({ value: r, children: a }) => {
    let o = se(M),
      s = r ?? o.transition,
      f = K(() => ({ ...o, transition: s }), [JSON.stringify(s)]);
    return e(M.Provider, { value: f, children: a });
  },
  za = m.create(b),
  Na = {
    "Variant 1": "u5cKgYsev",
  ...
  Ma = ({
    ...
    return {
      ...
      rX_TO6nhQ:
        (H = r ?? u.rX_TO6nhQ) !== null && H !== void 0
          ? H
          : "rgb(82, 137, 255)",
      Uf_khRTfT:
        (C = d ?? u.Uf_khRTfT) !== null && C !== void 0 ? C : "buy now",
      variant:
        (w = (k = Na[u.variant]) !== null && k !== void 0 ? k : u.variant) !==
          null && w !== void 0
          ? w
          : "u5cKgYsev",
  ...
  Za = E(function (r, a) {
    let { activeLocale: o, setLocale: s } = $(),
      ...
      ue = y(async (...Ve) => {
        if ((N({ isPressed: !1 }), C && (await C(...Ve)) === !1)) return !1;
      }),
      we = y(async (...Ve) => {
        if ((N({ isPressed: !1 }), C && (await C(...Ve)) === !1)) return !1;
        I("jKc7RP9Lw");
      ...
      xe = O(null),
      S = () => !["nup9PpipB", "jKc7RP9Lw"].includes(_),
      i = () =>
        !!(
              ...
              children: [
                e(te, {
                  ...
                  style: {
                    ...
                    "--variable-reference-NjAk50iJD-Ao3_VP088": k,
                  },
                  text: n,
                  variants: {
                    jChf2lud1: {
...
var Ba = { yk0TImxMb: { hover: !0, pressed: !0 } },
  ja = "framer-01hVG",
  Ea = { yk0TImxMb: "framer-v-1vynps9" };
function Da(r, ...a) {
  let o = {};
  return a?.forEach((s) => s && Object.assign(o, r[s])), o;
}
var Ya = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
  Wa = (r) =>
...
var ai = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
    ...
    return {
      ...
      Gac2rjSXD:
        (n = a ?? u.Gac2rjSXD) !== null && n !== void 0
          ...
          : "rgb(255, 255, 255)",
      GtAI8HSlp:
        (H = d ?? u.GtAI8HSlp) !== null && H !== void 0 ? H : "creators",
      v4tYVSv48: (C = o ?? u.v4tYVSv48) !== null && C !== void 0 ? C : 24,
    };
  },
  si = (r, a) =>
    r.layoutDependency ? a.join("-") + r.layoutDependency : a.join("-"),
  li = E(function (r, a) {
    let { activeLocale: o, setLocale: s } = $(),
      ...
      { activeVariantCallback: y, delay: he } = Ie(_),
      ue = y(async (...S) => {
        if ((N({ isPressed: !1 }), C && (await C(...S)) === !1)) return !1;
      }),
      we = O(null),
      ge = G(),
      ne = [],
            ...
            children: e(m.a, {
              ...
              children: e(te, {
                ...
                style: {
                  ...
                  "--variable-reference-v4tYVSv48-kROE2gJvT": k,
                },
                text: u,
                variants: {
                  "sNHMXI_B9-hover": {
...
var ui = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
  Nt = { delay: 0, duration: 0.1, ease: [0.44, 0, 0.56, 1], type: "tween" },
  Be = {
    opacity: 1,
    rotate: 0,
    rotateX: 0,
  ...
  zt = { delay: 0, duration: 4.2, ease: [0, 0, 1, 1], type: "tween" },
  ...
  _i = m.create(b),
  Hi = { "Variant 1": "uNOdB4q9_", mobile: "vcwO6svQk", tavlet: "eZ7gXPACW" },
  Ci = ({ height: r, id: a, width: o, ...s }) => {
    var f, g;
    return {
      ...s,
      variant:
        (g = (f = Hi[s.variant]) !== null && f !== void 0 ? f : s.variant) !==
          null && g !== void 0
          ? g
          : "uNOdB4q9_",
    };
  ...
  Fi = E(function (r, a) {
    let { activeLocale: o, setLocale: s } = $(),
      { style: f, className: g, layoutId: d, variant: x, ...u } = Ci(r),
      {
        baseVariant: n,
        classNames: H,
      ...
      children: e(_i, {
        ...
        children: e(bi, {
          ...
          children: v(m.div, {
            ...u,
            ...k,
            className: Y(gi, ...h, "framer-1ehnbt3", g, H),
            "data-border": !0,
            "data-framer-name": "Variant 1",
            layoutDependency: p,
            layoutId: "uNOdB4q9_",
                      ...
                      e(A, {
                        ...
                        children: e(m.div, {
                          ...
                          children: e(ke, {
                            ...
                            layoutId: "X9ugrOcIi",
                            style: { height: "100%", width: "100%" },
                            TeZLuQw15: "https://x.com/santaxmas_net",
                            width: "100%",
                          }),
                        }),
                      }),
                      ...
                      e(A, {
                        ...
                        children: e(m.div, {
                          ...
                          children: e(ke, {
                            ...
                            layoutId: "N7qyTNpdu",
                            style: { height: "100%", width: "100%" },
                            TeZLuQw15: "https://t.me/santaxmas_net",
                            width: "100%",
                          }),
                        }),
                      }),
                  ...
                  e(A, {
                    ...
                    children: e(m.div, {
                      ...
                      children: e(Te, {
                        ...
                        width: "100%",
                        Z9i0v4qpe:
                          "https://app.uniswap.org/#/swap?inputCurrency=eth&outputCurrency=0xc9a53E88AaEdd61ee7418B24519f87746062B846",
                        ...oe(
...
var Ii = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
  ...
  Ri = m.create(b),
  Pi = ({ height: r, id: a, width: o, ...s }) => ({ ...s }),
  zi = (r, a) =>
    r.layoutDependency ? a.join("-") + r.layoutDependency : a.join("-"),
  Ni = E(function (r, a) {
    let { activeLocale: o, setLocale: s } = $(),
      { style: f, className: g, layoutId: d, variant: x, ...u } = Pi(r),
      {
        baseVariant: n,
        classNames: H,
        clearLoadingGesture: C,
        ...
        children: e(Oi, {
          ...
          children: e(j, {
            ...
            children: v(m.a, {
              ...u,
              ...k,
              className: `${Y(Ti, ...I, "framer-2f1l57", g, H)} framer-1dsn0p3`,
              "data-border": !0,
              "data-framer-name": "Variant 1",
              layoutDependency: p,
              layoutId: "ts4_TZEYp",
  ...
  Tr = B(Ni, Mi, "framer-n2Cpd"),
  Vr = Tr;
Tr.displayName = "trailer skip";
Tr.defaultProps = { height: 46, width: 102 };
ee(
  Tr,
  [
    {
...
var qr = [
  ...
  Qi = "https://framer.com/m/feather-icons/",
  Zi = qr.map((r) => r.charAt(0).toUpperCase() + r.slice(1)),
  Li = qr.reduce((r, a) => ((r[a.toLowerCase()] = a), r), {});
function Oe(r) {
  let {
      color: a,
      selectByList: o,
    ...
    C = O(!1),
    k = Sr(qr, o, s, f, Li),
    [w, _] = Se(k === "Home" ? Qt(pe) : null);
  async function P() {
    let p = !0;
    try {
      let N = await import(`${Qi}${k}.js@0.0.29`);
      p && _(N.default(pe));
    } catch (z) {
      console.log(z), p && _(null);
    }
    return () => {
      p = !1;
    };
  ...
  let q = Ce.current() === Ce.canvas ? e(kr, {}) : null;
  return e("div", {
    style: { display: "contents" },
    onClick: g,
    onMouseEnter: u,
...
Q(Oe, {
  ...
  color: { type: c.Color, title: "Color", defaultValue: Oe.defaultProps.color },
  ...Fr,
});
var Bi = { YEg9NfTwc: { hover: !0, pressed: !0 } },
  ji = "framer-pwqh1",
  Ei = { YEg9NfTwc: "framer-v-1xm3gbd" };
function Zt(r, ...a) {
  let o = {};
  return a?.forEach((s) => s && Object.assign(o, r[s])), o;
}
var Di = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
  Yi = ({ value: r, children: a }) => {
    let o = se(M),
      s = r ?? o.transition,
      f = K(() => ({ ...o, transition: s }), [JSON.stringify(s)]);
    return e(M.Provider, { value: f, children: a });
            ...
            children: e(m.a, {
              ...
              children: e(te, {
                ...
                style: {
                  ...
                  "--variable-reference-v4tYVSv48-AtZT0oWzB": k,
                },
                text: u,
                variants: {
                  "YEg9NfTwc-hover": {
...
var Ji = { eCusnvi8g: { hover: !0, pressed: !0 } },
  $i = "framer-aJKVy",
        ...
        children: e(io, {
          ...
          children: e(j, {
            ...
            children: e(m.a, {
              ...H,
              ..._,
              className: `${Y($i, ...t, "framer-v70eay", g, k)} framer-p839jn`,
              "data-border": !0,
              "data-framer-name": "Variant 1",
              layoutDependency: N,
              layoutId: "eCusnvi8g",
...
var ho = { delay: 0, duration: 0.2, ease: [0.44, 0, 0.56, 1], type: "tween" },
  ...
  vo = ({
    ...
    return {
      ...
      variant:
        (H = (n = xo[d.variant]) !== null && n !== void 0 ? n : d.variant) !==
          null && H !== void 0
          ? H
          : "X4jyYGmF7",
        ...
        children: e(uo, {
          ...
          children: e(j, {
            ...
            children: e(m.a, {
              ...C,
              ...P,
              className: `${Y(fo, ...y, "framer-gt3cw8", g, w)} framer-ax3cs3`,
              "data-border": !0,
              "data-framer-name": "Variant 1",
              layoutDependency: I,
              layoutId: "X4jyYGmF7",
...
var Ho = W(Oe),
  ...
  Fo = W(Jr),
  So = W(ke),
  Ao = ["vCT7aHM9v", "xXRtnFAEN", "SaHO1PQUO", "GNR4NTEYU"],
  To = "framer-vc6gM",
  Vo = {
...
var qo = { bounce: 0.2, delay: 0, duration: 0.4, type: "spring" },
  Bt = (r, a) => `translateY(-50%) ${a}`,
  ...
  zo = ({ height: r, id: a, width: o, ...s }) => {
    var f, g;
    return {
      ...s,
      variant:
        (g = (f = Po[s.variant]) !== null && f !== void 0 ? f : s.variant) !==
          null && g !== void 0
          ? g
          : "vCT7aHM9v",
    };
  ...
  Mo = E(function (r, a) {
    let { activeLocale: o, setLocale: s } = $(),
      { style: f, className: g, layoutId: d, variant: x, ...u } = zo(r),
      {
        baseVariant: n,
        classNames: H,
        clearLoadingGesture: C,
      ...
      p = No(r, q),
      { activeVariantCallback: z, delay: N } = Ie(n),
      I = z(async (...V) => {
        Z("GNR4NTEYU");
      }),
      h = z(async (...V) => {
      ...
      children: e(Ro, {
        ...
        children: e(Oo, {
          ...
          children: v(m.div, {
            ...u,
            ...k,
            className: Y(To, ...S, "framer-1kg1rvq", g, H),
            "data-border": !0,
            "data-framer-name": "Variant 1",
            layoutDependency: p,
            layoutId: "vCT7aHM9v",
...
ee(pr, [{ explicitInter: !0, fonts: [] }, ...Ho, ...Co, ...ko, ...Fo, ...So], {
  supportsExplicitInterCodegen: !0,
});
var jt = ur(te),
  Zo = W(Te),
  ...
  Jo = { delay: 0.2, duration: 1, ease: [0.44, 0, 0.56, 1], type: "tween" },
  $o = {
    opacity: 1,
    rotate: 0,
    rotateX: 0,
  ...
  Fe = { delay: 1.5, duration: 4, ease: [0, 0, 1, 1], type: "tween" },
  Nr = {
    opacity: 0,
    rotate: 360,
    rotateX: 0,
  ...
  Kt = ({ children: r, blockDocumentScrolling: a, enabled: o = !0 }) => {
  ...
  Jt = { delay: 0, duration: 1.2, ease: [0.44, 0, 0.56, 1], type: "tween" },
  $t = {
    opacity: 1,
    rotate: 0,
    rotateX: 0,
  ...
  xn = E(function (r, a) {
    ...
    _e(() => {
      ...
      if (S.robots) {
        ...
        i
          ? i.setAttribute("content", S.robots)
      ...
      st(() => {
        ...
        if (((document.title = S.title || ""), S.viewport)) {
          ...
          (i = document.querySelector('meta[name="viewport"]')) === null ||
            i === void 0 ||
            i.setAttribute("content", S.viewport);
        }
        let V = S.bodyClassName;
        if (V) {
          let U = document.body;
          U.classList.forEach(
            (be) => be.startsWith("framer-body-") && U.classList.remove(be)
          ),
            U.classList.add(`${S.bodyClassName}-framer-ZqHO3`);
        }
        return () => {
          V &&
            document.body.classList.remove(`${S.bodyClassName}-framer-ZqHO3`);
        };
      }, [void 0, o]);
    let [n, H] = dt(x, Uo, !1),
      C = void 0,
      { activeVariantCallback: k, delay: w } = Ie(void 0),
      _ = ({ overlay: S, paginationInfo: i }) =>
        k(async (...V) => {
          S.toggle();
        }),
      P = O(null),
      ...
      e(ft.Provider, {
        ...
        children: v(J, {
          ...
          children: [
            v(m.div, {
              ...u,
              className: Y(Dt, ...xe, "framer-72rtr7", g),
              ref: a ?? P,
              style: { ...f },
              children: [
                v("div", {
                                  ...
                                  children: e(A, {
                                    ...
                                    children: e(ye, {
                                      ...
                                      children: e(F, {
                                        breakpoint: n,
                                        overrides: {
                                          AuBmYiANK: { Z9i0v4qpe: S[2] },
                                          mpnuVRSSM: { Z9i0v4qpe: S[1] },
                                        },
                                        children: e(Te, {
                                          height: "100%",
                                          id: "Bg2S11Xjj",
                                    ...
                                    AuBmYiANK: {
                                      children: e(b, {
                                        children: e("p", {
                                          ...
                                          children:
                                            "0xc9a53E88AaEdd61ee7418B24519f87746062B846",
                                        }),
                                      }),
                                    },
                                  },
                  ...
                  children: [
                    v("div", {
                      ...
                      children: [
                        ...
                        e(j, {
                          href: "https://x.com/santaxmas_net",
                          nodeId: "XOB1OMQYn",
                          openInNewTab: !0,
                          children: e(F, {
                            breakpoint: n,
            ...
            e("div", { className: Y(Dt, ...xe), id: "overlay" }),
          ],
        }),
      })
    );
  ...
  vn = [
    "@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }",
    ".framer-ZqHO3.framer-lux5qc, .framer-ZqHO3 .framer-lux5qc { display: block; }",
    ".framer-ZqHO3.framer-72rtr7 { align-content: center; align-items: center; background: linear-gradient(261deg, #0790ff 0%, rgba(4, 101, 179, 1) 39.63963963963964%, rgba(3, 80, 142, 1) 71.17117117117117%, rgb(0, 52, 94) 100%); display: flex; flex-direction: column; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px; position: relative; width: 1200px; }",
    ".framer-ZqHO3 .framer-ojpar0 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 100vh; justify-content: flex-start; overflow: hidden; padding: 130px 0px 0px 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-1w2ozi7 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 34px; height: min-content; justify-content: center; max-width: 676px; overflow: visible; padding: 20px 0px 20px 0px; position: relative; width: 100%; z-index: 6; }",
    ".framer-ZqHO3 .framer-i59rb8 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 13px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-1afr9v3, .framer-ZqHO3 .framer-19ub2e6, .framer-ZqHO3 .framer-1ut8bda, .framer-ZqHO3 .framer-lq2662 { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; flex: none; height: auto; position: relative; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
    ".framer-ZqHO3 .framer-wrpbwz, .framer-ZqHO3 .framer-96pbsz, .framer-ZqHO3 .framer-dgm2c6 { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; -webkit-user-select: none; flex: none; height: auto; position: relative; user-select: none; white-space: pre-wrap; width: 100%; word-break: break-word; word-wrap: break-word; }",
    ".framer-ZqHO3 .framer-1uzflw5, .framer-ZqHO3 .framer-1fstfmv { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-1aqszaz-container, .framer-ZqHO3 .framer-1pri9it-container, .framer-ZqHO3 .framer-hns3t4-container, .framer-ZqHO3 .framer-1p6n3su-container, .framer-ZqHO3 .framer-y6ppy8-container, .framer-ZqHO3 .framer-ea2hw0-container { flex: none; height: auto; position: relative; width: auto; }",
    ".framer-ZqHO3 .framer-tarptp, .framer-ZqHO3 .framer-1tbvxeq { background-color: rgba(0, 0, 0, 0.91); inset: 0px; position: fixed; user-select: none; z-index: 9; }",
    ".framer-ZqHO3 .framer-mnzsxw { aspect-ratio: 1.7857142857142858 / 1; border-bottom-left-radius: 30px; border-bottom-right-radius: 30px; border-top-left-radius: 30px; border-top-right-radius: 30px; flex: none; height: var(--framer-aspect-ratio-supported, 448px); left: 200px; overflow: hidden; position: fixed; right: 200px; top: 50%; transform: translateY(-50%); will-change: var(--framer-will-change-override, transform); z-index: 10; }",
    ".framer-ZqHO3 .framer-13bb91q-container, .framer-ZqHO3 .framer-1c7qgl3-container { bottom: 35px; flex: none; height: auto; position: absolute; right: 50px; width: auto; z-index: 8; }",
    ".framer-ZqHO3 .framer-izy82a-container { -webkit-user-select: none; aspect-ratio: 2.068062827225131 / 1; bottom: -20px; flex: none; left: 50%; position: absolute; top: -31px; transform: translateX(-50%); user-select: none; width: var(--framer-aspect-ratio-supported, 1032px); z-index: 1; }",
    ".framer-ZqHO3 .framer-xt9q8z, .framer-ZqHO3 .framer-1wzmqjo { -webkit-backdrop-filter: blur(5px); backdrop-filter: blur(5px); bottom: 0px; flex: none; left: 5px; overflow: hidden; position: fixed; right: 0px; top: 0px; z-index: 9; }",
    ".framer-ZqHO3 .framer-tkzb57, .framer-ZqHO3 .framer-8q3ud6 { -webkit-user-select: none; aspect-ratio: 1.1388888888888888 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 36px); left: 25%; overflow: visible; pointer-events: none; position: fixed; top: -85px; transform: translateX(-50%); user-select: none; width: 41px; z-index: 9; }",
    ".framer-ZqHO3 .framer-h4e6f0, .framer-ZqHO3 .framer-p2gzz5 { -webkit-user-select: none; aspect-ratio: 1.1388888888888888 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 22px); left: 116px; overflow: visible; pointer-events: none; position: fixed; top: -85px; user-select: none; width: 25px; z-index: 9; }",
    ".framer-ZqHO3 .framer-oo8o2t, .framer-ZqHO3 .framer-1dpqcqv { -webkit-user-select: none; aspect-ratio: 1.1176470588235294 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 17px); overflow: visible; pointer-events: none; position: fixed; right: 188px; top: -53px; user-select: none; width: 19px; z-index: 9; }",
    ".framer-ZqHO3 .framer-vdokkq, .framer-ZqHO3 .framer-2xyf5g { -webkit-user-select: none; aspect-ratio: 1.2142857142857142 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 34px); left: 45%; overflow: visible; pointer-events: none; position: fixed; top: -76px; transform: translateX(-50%); user-select: none; width: 41px; z-index: 9; }",
    ".framer-ZqHO3 .framer-1w0ybz8, .framer-ZqHO3 .framer-uw0od6 { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 15px); overflow: visible; pointer-events: none; position: fixed; right: 475px; top: -51px; user-select: none; width: 13px; z-index: 9; }",
    ".framer-ZqHO3 .framer-1l3m5ad, .framer-ZqHO3 .framer-c98e3x { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 34px); left: 86%; overflow: visible; pointer-events: none; position: fixed; top: -51px; transform: translateX(-50%); user-select: none; width: 29px; z-index: 9; }",
    ".framer-ZqHO3 .framer-q3ae3v, .framer-ZqHO3 .framer-1k8gcym { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 21px); overflow: visible; pointer-events: none; position: fixed; right: 258px; top: -51px; user-select: none; width: 18px; z-index: 9; }",
    ".framer-ZqHO3 .framer-1rg92tm, .framer-ZqHO3 .framer-150ss5z { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 21px); left: 20%; overflow: visible; pointer-events: none; position: fixed; top: -69px; transform: translateX(-50%); user-select: none; width: 18px; z-index: 9; }",
    ".framer-ZqHO3 .framer-1ac55ix, .framer-ZqHO3 .framer-1e1g5rx { -webkit-user-select: none; aspect-ratio: 1.2142857142857142 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 28px); overflow: visible; pointer-events: none; position: fixed; right: 481px; top: -76px; user-select: none; width: 34px; z-index: 9; }",
    ".framer-ZqHO3 .framer-120krdt { -webkit-user-select: none; bottom: 0px; flex: none; left: 0px; opacity: 0.1; overflow: hidden; pointer-events: none; position: absolute; right: 0px; top: 0px; user-select: none; z-index: 1; }",
    ".framer-ZqHO3 .framer-1cginiy { -webkit-user-select: none; bottom: -148px; flex: none; left: 0px; opacity: 0.42; overflow: hidden; pointer-events: none; position: absolute; right: 0px; top: 20px; user-select: none; z-index: 1; }",
    ".framer-ZqHO3 .framer-921lyg { -webkit-user-select: none; aspect-ratio: 1.7777777777777777 / 1; bottom: -47px; flex: none; height: var(--framer-aspect-ratio-supported, 675px); left: 0px; overflow: visible; pointer-events: none; position: absolute; right: 0px; user-select: none; z-index: 7; }",
    ".framer-ZqHO3 .framer-73ad1d { -webkit-user-select: none; aspect-ratio: 1.1388888888888888 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 36px); left: 25%; overflow: visible; pointer-events: none; position: absolute; top: -85px; transform: translateX(-50%); user-select: none; width: 41px; z-index: 2; }",
    ".framer-ZqHO3 .framer-2o7als { -webkit-user-select: none; aspect-ratio: 1.1388888888888888 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 22px); left: 116px; overflow: visible; pointer-events: none; position: absolute; top: -85px; user-select: none; width: 25px; z-index: 2; }",
    ".framer-ZqHO3 .framer-3znpmj { -webkit-user-select: none; aspect-ratio: 1.1176470588235294 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 17px); overflow: visible; pointer-events: none; position: absolute; right: 188px; top: -53px; user-select: none; width: 19px; z-index: 2; }",
    ".framer-ZqHO3 .framer-1uh70ww { -webkit-user-select: none; aspect-ratio: 1.2142857142857142 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 34px); left: 45%; overflow: visible; pointer-events: none; position: absolute; top: -76px; transform: translateX(-50%); user-select: none; width: 41px; z-index: 2; }",
    ".framer-ZqHO3 .framer-sp8neh { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 15px); overflow: visible; pointer-events: none; position: absolute; right: 475px; top: -51px; user-select: none; width: 13px; z-index: 2; }",
    ".framer-ZqHO3 .framer-118vdjf { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 34px); left: 86%; overflow: visible; pointer-events: none; position: absolute; top: -51px; transform: translateX(-50%); user-select: none; width: 29px; z-index: 2; }",
    ".framer-ZqHO3 .framer-1s6l4iz { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 21px); overflow: visible; pointer-events: none; position: absolute; right: 258px; top: -51px; user-select: none; width: 18px; z-index: 2; }",
    ".framer-ZqHO3 .framer-z1bit0 { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 21px); left: 20%; overflow: visible; pointer-events: none; position: absolute; top: -51px; transform: translateX(-50%); user-select: none; width: 18px; z-index: 2; }",
    ".framer-ZqHO3 .framer-tr6h17 { -webkit-user-select: none; aspect-ratio: 1.2142857142857142 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 28px); overflow: visible; pointer-events: none; position: absolute; right: 481px; top: -76px; user-select: none; width: 34px; z-index: 2; }",
    ".framer-ZqHO3 .framer-vr5d2p { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-bcf5hh { aspect-ratio: 4.419117647058823 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 272px); overflow: visible; position: relative; width: 100%; z-index: 8; }",
    ".framer-ZqHO3 .framer-1tezp47 { -webkit-user-select: none; aspect-ratio: 1.1388888888888888 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 36px); left: 25%; overflow: visible; pointer-events: none; position: absolute; top: 37px; transform: translateX(-50%); user-select: none; width: 41px; z-index: 7; }",
    ".framer-ZqHO3 .framer-nnevxs { -webkit-user-select: none; aspect-ratio: 1.1388888888888888 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 22px); left: 116px; overflow: visible; pointer-events: none; position: absolute; top: 37px; user-select: none; width: 25px; z-index: 7; }",
    ".framer-ZqHO3 .framer-1j333x0 { -webkit-user-select: none; aspect-ratio: 1.1176470588235294 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 17px); overflow: visible; pointer-events: none; position: absolute; right: 188px; top: 37px; user-select: none; width: 19px; z-index: 7; }",
    ".framer-ZqHO3 .framer-1chebas { -webkit-user-select: none; aspect-ratio: 1.2142857142857142 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 34px); left: 45%; overflow: visible; pointer-events: none; position: absolute; top: 37px; transform: translateX(-50%); user-select: none; width: 41px; z-index: 7; }",
    ".framer-ZqHO3 .framer-1cutezd { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 15px); overflow: visible; pointer-events: none; position: absolute; right: 475px; top: 37px; user-select: none; width: 13px; z-index: 7; }",
    ".framer-ZqHO3 .framer-3iorgt { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 34px); left: 86%; overflow: visible; pointer-events: none; position: absolute; top: 37px; transform: translateX(-50%); user-select: none; width: 29px; z-index: 7; }",
    ".framer-ZqHO3 .framer-ciwsbk { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 21px); overflow: visible; pointer-events: none; position: absolute; right: 258px; top: 37px; user-select: none; width: 18px; z-index: 7; }",
    ".framer-ZqHO3 .framer-1k9ra1w { -webkit-user-select: none; aspect-ratio: 0.86 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 21px); left: 20%; overflow: visible; pointer-events: none; position: absolute; top: 37px; transform: translateX(-50%); user-select: none; width: 18px; z-index: 7; }",
    ".framer-ZqHO3 .framer-zevn0c { -webkit-user-select: none; aspect-ratio: 1.2142857142857142 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 28px); overflow: visible; pointer-events: none; position: absolute; right: 481px; top: 37px; user-select: none; width: 34px; z-index: 7; }",
    ".framer-ZqHO3 .framer-2ckrpk { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 70px 0px 174px 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-10jugcv { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; scroll-margin-top: 233px; width: 100%; }",
    ".framer-ZqHO3 .framer-1h9llgh { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 27px; height: min-content; justify-content: center; overflow: visible; padding: 0px 0px 0px 50px; position: relative; width: 1px; }",
    ".framer-ZqHO3 .framer-uxwbvx, .framer-ZqHO3 .framer-1lpnmak { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-16b8kyl { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-118i646 { aspect-ratio: 1.7857142857142858 / 1; border-bottom-left-radius: 30px; border-bottom-right-radius: 30px; border-top-left-radius: 30px; border-top-right-radius: 30px; flex: none; height: var(--framer-aspect-ratio-supported, 812px); left: 200px; overflow: hidden; position: fixed; right: 200px; top: 50%; transform: translateY(-50%); will-change: var(--framer-will-change-override, transform); z-index: 10; }",
    ".framer-ZqHO3 .framer-vrsh8n-container { -webkit-user-select: none; aspect-ratio: 2.068062827225131 / 1; bottom: -20px; flex: none; left: 50%; position: absolute; top: -31px; transform: translateX(-50%); user-select: none; width: var(--framer-aspect-ratio-supported, 1264px); z-index: 1; }",
    ".framer-ZqHO3 .framer-1w7t02l { flex: none; height: 1px; overflow: hidden; position: relative; width: 45%; }",
    ".framer-ZqHO3 .framer-1uhzijc { -webkit-user-select: none; aspect-ratio: 1.7751479289940828 / 1; bottom: -2px; flex: none; height: var(--framer-aspect-ratio-supported, 676px); left: 0px; overflow: visible; pointer-events: none; position: absolute; right: 0px; user-select: none; z-index: 1; }",
    ".framer-ZqHO3 .framer-1y3rwsq, .framer-ZqHO3 .framer-1sndhsk { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-kogdca, .framer-ZqHO3 .framer-1x2t1fo { aspect-ratio: 4.419117647058823 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 272px); overflow: visible; position: relative; width: 100%; z-index: 1; }",
    ".framer-ZqHO3 .framer-1nk3q5w { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 30px; height: min-content; justify-content: center; overflow: visible; padding: 40px 0px 0px 0px; position: relative; scroll-margin-top: 50px; width: 100%; }",
    ".framer-ZqHO3 .framer-u4v5mn, .framer-ZqHO3 .framer-1f69c5f { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 46px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 1px; }",
    ".framer-ZqHO3 .framer-w7ovhw, .framer-ZqHO3 .framer-1qby9a4, .framer-ZqHO3 .framer-98gov0, .framer-ZqHO3 .framer-yrll2l { aspect-ratio: 1.516061084781464 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 393px); overflow: visible; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-1ikb0wg { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 200px 0px 449px 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-141voyk { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-wj01cq { flex: none; height: 1px; overflow: hidden; position: relative; width: 40%; }",
    ".framer-ZqHO3 .framer-52oss6 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 27px; height: min-content; justify-content: center; max-width: 874px; overflow: hidden; padding: 0px 50px 0px 0px; position: relative; width: 1px; }",
    ".framer-ZqHO3 .framer-163mz6e { --border-bottom-width: 4px; --border-color: #000000; --border-left-width: 1px; --border-right-width: 4px; --border-style: solid; --border-top-width: 1px; align-content: center; align-items: center; background-color: #f7f5f6; border-bottom-left-radius: 136px; border-bottom-right-radius: 136px; border-top-left-radius: 136px; border-top-right-radius: 136px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 5px 15px 7px 15px; position: relative; width: 100%; will-change: var(--framer-will-change-override, transform); }",
    ".framer-ZqHO3 .framer-xeydfb { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; -webkit-user-select: none; flex: none; height: auto; position: relative; user-select: none; white-space: pre; width: auto; }",
    ".framer-ZqHO3 .framer-wfdb6i { --framer-link-text-color: #0099ff; --framer-link-text-decoration: underline; -webkit-user-select: none; flex: 1 0 0px; height: auto; position: relative; user-select: none; white-space: pre-wrap; width: 1px; word-break: break-word; word-wrap: break-word; }",
    ".framer-ZqHO3 .framer-vv02t8 { -webkit-user-select: none; aspect-ratio: 1.8099547511312217 / 1; bottom: -1px; flex: none; height: var(--framer-aspect-ratio-supported, 663px); left: 0px; overflow: visible; pointer-events: none; position: absolute; right: 0px; user-select: none; z-index: 1; }",
    ".framer-ZqHO3 .framer-1enzhqg { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 0px 0px 374px 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-fwkex2 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 22px; height: min-content; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 100%; }",
    ".framer-ZqHO3 .framer-p818jg, .framer-ZqHO3 .framer-18wed9n, .framer-ZqHO3 .framer-12ctwn1, .framer-ZqHO3 .framer-1xf3oah { aspect-ratio: 1.104796320630749 / 1; cursor: pointer; flex: none; height: var(--framer-aspect-ratio-supported, 80px); overflow: visible; position: relative; text-decoration: none; width: 88px; }",
    ".framer-ZqHO3 .framer-1k7nkm7 { -webkit-user-select: none; aspect-ratio: 2.079722703639515 / 1; bottom: 0px; flex: none; height: var(--framer-aspect-ratio-supported, 577px); left: 0px; overflow: visible; pointer-events: none; position: absolute; right: 0px; user-select: none; z-index: 1; }",
    ".framer-ZqHO3 .framer-1mf8jh-container { flex: none; height: auto; left: 100px; position: fixed; right: 100px; top: 10px; z-index: 8; }",
    ".framer-ZqHO3 .framer-150d8vz-container { flex: none; height: auto; left: 10px; position: fixed; right: 10px; top: 5px; z-index: 8; }",
    ".framer-ZqHO3 .framer-lpd48f { align-content: center; align-items: center; bottom: 30px; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 28px; justify-content: center; overflow: hidden; padding: 0px; position: fixed; right: 30px; width: 128px; z-index: 10; }",
    ".framer-ZqHO3 .framer-d0e8ag-container { flex: none; height: 28px; position: relative; width: 128px; z-index: 8; }",
    "@supports (background: -webkit-named-image(i)) and (not (scale:1)) { .framer-ZqHO3.framer-72rtr7, .framer-ZqHO3 .framer-ojpar0, .framer-ZqHO3 .framer-1w2ozi7, .framer-ZqHO3 .framer-i59rb8, .framer-ZqHO3 .framer-1uzflw5, .framer-ZqHO3 .framer-vr5d2p, .framer-ZqHO3 .framer-2ckrpk, .framer-ZqHO3 .framer-10jugcv, .framer-ZqHO3 .framer-1h9llgh, .framer-ZqHO3 .framer-uxwbvx, .framer-ZqHO3 .framer-16b8kyl, .framer-ZqHO3 .framer-1y3rwsq, .framer-ZqHO3 .framer-1nk3q5w, .framer-ZqHO3 .framer-1fstfmv, .framer-ZqHO3 .framer-u4v5mn, .framer-ZqHO3 .framer-1f69c5f, .framer-ZqHO3 .framer-1ikb0wg, .framer-ZqHO3 .framer-141voyk, .framer-ZqHO3 .framer-52oss6, .framer-ZqHO3 .framer-1lpnmak, .framer-ZqHO3 .framer-163mz6e, .framer-ZqHO3 .framer-1sndhsk, .framer-ZqHO3 .framer-1enzhqg, .framer-ZqHO3 .framer-fwkex2, .framer-ZqHO3 .framer-lpd48f { gap: 0px; } .framer-ZqHO3.framer-72rtr7 > * { margin: 0px; margin-bottom: calc(0px / 2); margin-top: calc(0px / 2); } .framer-ZqHO3.framer-72rtr7 > :first-child, .framer-ZqHO3 .framer-ojpar0 > :first-child, .framer-ZqHO3 .framer-1w2ozi7 > :first-child, .framer-ZqHO3 .framer-i59rb8 > :first-child, .framer-ZqHO3 .framer-vr5d2p > :first-child, .framer-ZqHO3 .framer-2ckrpk > :first-child, .framer-ZqHO3 .framer-1h9llgh > :first-child, .framer-ZqHO3 .framer-uxwbvx > :first-child, .framer-ZqHO3 .framer-1y3rwsq > :first-child, .framer-ZqHO3 .framer-1nk3q5w > :first-child, .framer-ZqHO3 .framer-u4v5mn > :first-child, .framer-ZqHO3 .framer-1f69c5f > :first-child, .framer-ZqHO3 .framer-1ikb0wg > :first-child, .framer-ZqHO3 .framer-52oss6 > :first-child, .framer-ZqHO3 .framer-1lpnmak > :first-child, .framer-ZqHO3 .framer-1sndhsk > :first-child, .framer-ZqHO3 .framer-1enzhqg > :first-child { margin-top: 0px; } .framer-ZqHO3.framer-72rtr7 > :last-child, .framer-ZqHO3 .framer-ojpar0 > :last-child, .framer-ZqHO3 .framer-1w2ozi7 > :last-child, .framer-ZqHO3 .framer-i59rb8 > :last-child, .framer-ZqHO3 .framer-vr5d2p > :last-child, .framer-ZqHO3 .framer-2ckrpk > :last-child, .framer-ZqHO3 .framer-1h9llgh > :last-child, .framer-ZqHO3 .framer-uxwbvx > :last-child, .framer-ZqHO3 .framer-1y3rwsq > :last-child, .framer-ZqHO3 .framer-1nk3q5w > :last-child, .framer-ZqHO3 .framer-u4v5mn > :last-child, .framer-ZqHO3 .framer-1f69c5f > :last-child, .framer-ZqHO3 .framer-1ikb0wg > :last-child, .framer-ZqHO3 .framer-52oss6 > :last-child, .framer-ZqHO3 .framer-1lpnmak > :last-child, .framer-ZqHO3 .framer-1sndhsk > :last-child, .framer-ZqHO3 .framer-1enzhqg > :last-child { margin-bottom: 0px; } .framer-ZqHO3 .framer-ojpar0 > *, .framer-ZqHO3 .framer-vr5d2p > *, .framer-ZqHO3 .framer-2ckrpk > *, .framer-ZqHO3 .framer-uxwbvx > *, .framer-ZqHO3 .framer-1y3rwsq > *, .framer-ZqHO3 .framer-1ikb0wg > *, .framer-ZqHO3 .framer-1lpnmak > *, .framer-ZqHO3 .framer-1sndhsk > *, .framer-ZqHO3 .framer-1enzhqg > * { margin: 0px; margin-bottom: calc(10px / 2); margin-top: calc(10px / 2); } .framer-ZqHO3 .framer-1w2ozi7 > * { margin: 0px; margin-bottom: calc(34px / 2); margin-top: calc(34px / 2); } .framer-ZqHO3 .framer-i59rb8 > * { margin: 0px; margin-bottom: calc(13px / 2); margin-top: calc(13px / 2); } .framer-ZqHO3 .framer-1uzflw5 > *, .framer-ZqHO3 .framer-10jugcv > *, .framer-ZqHO3 .framer-16b8kyl > *, .framer-ZqHO3 .framer-1fstfmv > *, .framer-ZqHO3 .framer-141voyk > *, .framer-ZqHO3 .framer-163mz6e > *, .framer-ZqHO3 .framer-lpd48f > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-ZqHO3 .framer-1uzflw5 > :first-child, .framer-ZqHO3 .framer-10jugcv > :first-child, .framer-ZqHO3 .framer-16b8kyl > :first-child, .framer-ZqHO3 .framer-1fstfmv > :first-child, .framer-ZqHO3 .framer-141voyk > :first-child, .framer-ZqHO3 .framer-163mz6e > :first-child, .framer-ZqHO3 .framer-fwkex2 > :first-child, .framer-ZqHO3 .framer-lpd48f > :first-child { margin-left: 0px; } .framer-ZqHO3 .framer-1uzflw5 > :last-child, .framer-ZqHO3 .framer-10jugcv > :last-child, .framer-ZqHO3 .framer-16b8kyl > :last-child, .framer-ZqHO3 .framer-1fstfmv > :last-child, .framer-ZqHO3 .framer-141voyk > :last-child, .framer-ZqHO3 .framer-163mz6e > :last-child, .framer-ZqHO3 .framer-fwkex2 > :last-child, .framer-ZqHO3 .framer-lpd48f > :last-child { margin-right: 0px; } .framer-ZqHO3 .framer-1h9llgh > *, .framer-ZqHO3 .framer-52oss6 > * { margin: 0px; margin-bottom: calc(27px / 2); margin-top: calc(27px / 2); } .framer-ZqHO3 .framer-1nk3q5w > * { margin: 0px; margin-bottom: calc(30px / 2); margin-top: calc(30px / 2); } .framer-ZqHO3 .framer-u4v5mn > *, .framer-ZqHO3 .framer-1f69c5f > * { margin: 0px; margin-bottom: calc(46px / 2); margin-top: calc(46px / 2); } .framer-ZqHO3 .framer-fwkex2 > * { margin: 0px; margin-left: calc(22px / 2); margin-right: calc(22px / 2); } }",
    "@media (min-width: 810px) and (max-width: 1199px) { .framer-ZqHO3.framer-72rtr7 { width: 810px; } .framer-ZqHO3 .framer-mnzsxw { height: var(--framer-aspect-ratio-supported, 375px); left: 70px; right: 70px; top: 49%; } .framer-ZqHO3 .framer-izy82a-container { width: var(--framer-aspect-ratio-supported, 882px); } .framer-ZqHO3 .framer-921lyg { bottom: 0px; height: var(--framer-aspect-ratio-supported, 456px); } .framer-ZqHO3 .framer-bcf5hh, .framer-ZqHO3 .framer-kogdca { height: var(--framer-aspect-ratio-supported, 184px); } .framer-ZqHO3 .framer-1h9llgh { padding: 0px 0px 0px 20px; } .framer-ZqHO3 .framer-96pbsz { max-width: 598px; } .framer-ZqHO3 .framer-y6ppy8-container { flex: 1 0 0px; max-width: 235px; width: 1px; } .framer-ZqHO3 .framer-118i646 { height: var(--framer-aspect-ratio-supported, 370px); left: 70px; right: 70px; top: 49%; } .framer-ZqHO3 .framer-1uhzijc { height: var(--framer-aspect-ratio-supported, 456px); } .framer-ZqHO3 .framer-w7ovhw, .framer-ZqHO3 .framer-1qby9a4, .framer-ZqHO3 .framer-yrll2l { height: var(--framer-aspect-ratio-supported, 264px); } .framer-ZqHO3 .framer-98gov0 { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: var(--framer-aspect-ratio-supported, 264px); justify-content: center; padding: 0px; } .framer-ZqHO3 .framer-1ikb0wg { padding: 57px 0px 260px 0px; } .framer-ZqHO3 .framer-vv02t8 { height: var(--framer-aspect-ratio-supported, 448px); } .framer-ZqHO3 .framer-1x2t1fo { height: var(--framer-aspect-ratio-supported, 183px); } .framer-ZqHO3 .framer-1enzhqg { height: 385px; padding: 0px 0px 200px 0px; } .framer-ZqHO3 .framer-1k7nkm7 { height: var(--framer-aspect-ratio-supported, 390px); } @supports (background: -webkit-named-image(i)) and (not (scale:1)) { .framer-ZqHO3 .framer-98gov0 { gap: 0px; } .framer-ZqHO3 .framer-98gov0 > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-ZqHO3 .framer-98gov0 > :first-child { margin-left: 0px; } .framer-ZqHO3 .framer-98gov0 > :last-child { margin-right: 0px; } }}",
    "@media (max-width: 809px) { .framer-ZqHO3.framer-72rtr7 { width: 390px; } .framer-ZqHO3 .framer-1uzflw5 { flex-direction: column; } .framer-ZqHO3 .framer-mnzsxw { aspect-ratio: 1.7863777089783281 / 1; height: var(--framer-aspect-ratio-supported, 323px); left: -93px; right: -94px; top: 50%; } .framer-ZqHO3 .framer-13bb91q-container { bottom: 23px; right: 21px; } .framer-ZqHO3 .framer-izy82a-container { bottom: -52px; left: 50%; top: -53px; width: var(--framer-aspect-ratio-supported, 885px); } .framer-ZqHO3 .framer-921lyg { bottom: 0px; height: var(--framer-aspect-ratio-supported, 220px); } .framer-ZqHO3 .framer-bcf5hh { height: var(--framer-aspect-ratio-supported, 89px); } .framer-ZqHO3 .framer-1tezp47 { left: 25%; top: 9px; } .framer-ZqHO3 .framer-nnevxs, .framer-ZqHO3 .framer-1j333x0, .framer-ZqHO3 .framer-1cutezd, .framer-ZqHO3 .framer-ciwsbk, .framer-ZqHO3 .framer-zevn0c { top: 9px; } .framer-ZqHO3 .framer-1chebas { left: 45%; top: 9px; } .framer-ZqHO3 .framer-3iorgt { left: 86%; top: 9px; } .framer-ZqHO3 .framer-1k9ra1w { left: 21%; top: 9px; } .framer-ZqHO3 .framer-2ckrpk { padding: 80px 0px 100px 0px; } .framer-ZqHO3 .framer-1h9llgh { gap: 16px; padding: 0px 20px 0px 10px; } .framer-ZqHO3 .framer-uxwbvx { order: 0; } .framer-ZqHO3 .framer-96pbsz { max-width: 388px; } .framer-ZqHO3 .framer-16b8kyl { align-content: flex-start; align-items: flex-start; flex-direction: column; order: 1; } .framer-ZqHO3 .framer-1p6n3su-container { width: 234px; } .framer-ZqHO3 .framer-y6ppy8-container { width: 215px; } .framer-ZqHO3 .framer-1w7t02l, .framer-ZqHO3 .framer-wj01cq { width: 0%; } .framer-ZqHO3 .framer-1uhzijc { height: var(--framer-aspect-ratio-supported, 243px); left: -20px; right: -20px; } .framer-ZqHO3 .framer-kogdca, .framer-ZqHO3 .framer-1x2t1fo { height: var(--framer-aspect-ratio-supported, 88px); } .framer-ZqHO3 .framer-1nk3q5w { padding: 50px 0px 0px 0px; } .framer-ZqHO3 .framer-1fstfmv { flex-direction: column; gap: 0px; } .framer-ZqHO3 .framer-u4v5mn, .framer-ZqHO3 .framer-1f69c5f, .framer-ZqHO3 .framer-wfdb6i { flex: none; width: 100%; } .framer-ZqHO3 .framer-w7ovhw, .framer-ZqHO3 .framer-1qby9a4, .framer-ZqHO3 .framer-98gov0 { height: var(--framer-aspect-ratio-supported, 257px); } .framer-ZqHO3 .framer-yrll2l { height: var(--framer-aspect-ratio-supported, 258px); } .framer-ZqHO3 .framer-1ikb0wg { padding: 50px 0px 208px 0px; } .framer-ZqHO3 .framer-52oss6 { flex-direction: row; gap: 16px; padding: 0px 20px 0px 0px; } .framer-ZqHO3 .framer-1lpnmak { flex: 1 0 0px; order: 1; width: 1px; } .framer-ZqHO3 .framer-163mz6e { border-bottom-left-radius: 24px; border-bottom-right-radius: 24px; border-top-left-radius: 24px; border-top-right-radius: 24px; flex-direction: column; gap: 8px; order: 0; width: 36%; } .framer-ZqHO3 .framer-vv02t8 { aspect-ratio: 1.797752808988764 / 1; bottom: -1px; height: var(--framer-aspect-ratio-supported, 223px); left: -5px; right: -5px; } .framer-ZqHO3 .framer-1enzhqg { height: 187px; padding: 0px 0px 100px 0px; } .framer-ZqHO3 .framer-fwkex2 { gap: 13px; } .framer-ZqHO3 .framer-p818jg, .framer-ZqHO3 .framer-18wed9n, .framer-ZqHO3 .framer-12ctwn1, .framer-ZqHO3 .framer-1xf3oah { height: var(--framer-aspect-ratio-supported, 33px); width: 36px; } .framer-ZqHO3 .framer-1k7nkm7 { aspect-ratio: 1.7668161434977578 / 1; height: var(--framer-aspect-ratio-supported, 221px); } @supports (background: -webkit-named-image(i)) and (not (scale:1)) { .framer-ZqHO3 .framer-1uzflw5, .framer-ZqHO3 .framer-1h9llgh, .framer-ZqHO3 .framer-16b8kyl, .framer-ZqHO3 .framer-1fstfmv, .framer-ZqHO3 .framer-52oss6, .framer-ZqHO3 .framer-163mz6e, .framer-ZqHO3 .framer-fwkex2 { gap: 0px; } .framer-ZqHO3 .framer-1uzflw5 > *, .framer-ZqHO3 .framer-16b8kyl > * { margin: 0px; margin-bottom: calc(10px / 2); margin-top: calc(10px / 2); } .framer-ZqHO3 .framer-1uzflw5 > :first-child, .framer-ZqHO3 .framer-1h9llgh > :first-child, .framer-ZqHO3 .framer-16b8kyl > :first-child, .framer-ZqHO3 .framer-1fstfmv > :first-child, .framer-ZqHO3 .framer-163mz6e > :first-child { margin-top: 0px; } .framer-ZqHO3 .framer-1uzflw5 > :last-child, .framer-ZqHO3 .framer-1h9llgh > :last-child, .framer-ZqHO3 .framer-16b8kyl > :last-child, .framer-ZqHO3 .framer-1fstfmv > :last-child, .framer-ZqHO3 .framer-163mz6e > :last-child { margin-bottom: 0px; } .framer-ZqHO3 .framer-1h9llgh > * { margin: 0px; margin-bottom: calc(16px / 2); margin-top: calc(16px / 2); } .framer-ZqHO3 .framer-1fstfmv > * { margin: 0px; margin-bottom: calc(0px / 2); margin-top: calc(0px / 2); } .framer-ZqHO3 .framer-52oss6 > * { margin: 0px; margin-left: calc(16px / 2); margin-right: calc(16px / 2); } .framer-ZqHO3 .framer-52oss6 > :first-child, .framer-ZqHO3 .framer-fwkex2 > :first-child { margin-left: 0px; } .framer-ZqHO3 .framer-52oss6 > :last-child, .framer-ZqHO3 .framer-fwkex2 > :last-child { margin-right: 0px; } .framer-ZqHO3 .framer-163mz6e > * { margin: 0px; margin-bottom: calc(8px / 2); margin-top: calc(8px / 2); } .framer-ZqHO3 .framer-fwkex2 > * { margin: 0px; margin-left: calc(13px / 2); margin-right: calc(13px / 2); } }}",
    '.framer-ZqHO3[data-border="true"]::after, .framer-ZqHO3 [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }',
  ],
  Zr = B(xn, vn, "framer-ZqHO3"),
  Ol = Zr;
Zr.displayName = "Home";
Zr.defaultProps = { height: 4810.5, width: 1200 };
ee(
  Zr,
  [
    {
...
export { Rl as __FramerMetadata__, Ol as default };
//# sourceMappingURL=DhgfVmwKhJ99msEw2Z1jc7-aSwQJ8rEotzByE-Up-eo.256WRQXK.mjs.map
